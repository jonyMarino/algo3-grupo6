...
public class FabricaDeCajas extends FabricaDePartes {
	...
	public FabricaDeCajas(){
		super();
		agregarModelo(nuevoModeloCaja("Ford NT10",200, "Caja Manual básica.", 100.0, "MANUAL"));
		agregarModelo(nuevoModeloCaja("Nisan 123",200, "Caja Automática básica.", 80.0, "AUTOMATICA"));
	}
